...
from app_2.lib.enums import HoleStatus, ChatMessageType
from app_2.lib.exception import NotFound, HoleUnEnabled, TextContentIllegal
from app_2.lib.schema import chat_schema
from app_2.model.chat import Chat
from app_2.model.hole import Hole
from app_2.service.mp import get_mp_client
...
class ChatNameSpace(Namespace):
    ...
    def on_join(cls, data):
        ...
        加入房间
        """
        from app_2 import verify_token, chat_room_db
    ...
    def on_leave(cls, data):
        ...
        离开房间
        """
        from app_2 import chat_room_db
